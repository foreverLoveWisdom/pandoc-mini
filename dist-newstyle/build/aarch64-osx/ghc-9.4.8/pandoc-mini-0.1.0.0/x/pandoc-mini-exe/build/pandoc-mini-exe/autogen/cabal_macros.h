...
/* package pandoc-mini-0.1.0.0 */
#ifndef VERSION_pandoc_mini
#define VERSION_pandoc_mini "0.1.0.0"
#endif /* VERSION_pandoc_mini */
#ifndef MIN_VERSION_pandoc_mini
#define MIN_VERSION_pandoc_mini(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pandoc_mini */
...
/* package doctest-0.22.9 */
#ifndef VERSION_doctest
#define VERSION_doctest "0.22.9"
...
#define CURRENT_COMPONENT_ID "pandoc-mini-0.1.0.0-inplace-pandoc-mini-exe"
